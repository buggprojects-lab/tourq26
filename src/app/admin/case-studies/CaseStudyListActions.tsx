...
export function CaseStudyListActions({ slug }: { slug: string }) {
  ...
  const handleDelete = async () => {
    ...
    setBusy(true);
    const res = await fetch(`/api/admin/content/case-studies/${encodeURIComponent(slug)}`, {
      method: "DELETE",
    });
    setBusy(false);
  ...
  return (
    <div className="inline-flex items-center gap-1.5">
      <Link
        href={`/admin/case-studies/${encodeURIComponent(slug)}/edit`}
